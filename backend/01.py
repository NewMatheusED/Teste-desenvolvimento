...
# loop entre as lojas
for i in response:
    # loop entre os produtos das lojas
    for j in i['produtos']:
        if j['preço'] > 30:
            # se for maior, coloca no array de retiradosst
            retirados.append(j)
        else:
            # se não foi, coloca no array de produtos
            produtos.append(j)
...
# Como acabei de ver isso na faculdade, ainda está bem fresco na cabeça, o que fez essa ser a solução mais clara pra mim